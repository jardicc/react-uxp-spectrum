...
export default function Slider(props) {
    ...
    return (React.createElement("sp-slider", { ref: ref, "class": props.className, disabled: props.disabled || undefined, "fill-offset": props.fillOffset, min: props.min, max: props.max, "show-value": props.showValue === false ? false : undefined, value: props.value, "value-label": props.valueLabel, variant: props.variant, size: (props === null || props === void 0 ? void 0 : props.size) || SpectrumComponetDefaults.defaultSize, step: props.step }, props === null || props === void 0 ? void 0 : props.children));
}
